...
import com.example.msap_vtor_del.NetworkTasks.NetworkCheckClass;
import com.example.msap_vtor_del.NetworkTasks.NetworkPING;
import com.example.msap_vtor_del.Notification.ServiceNotification;
...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        SharedPreferences prefs= getSharedPreferences("com.example.msap_vtor_del.ActiveServiceRunning", MODE_PRIVATE);
    ...
    public void taskDelayLoop(){
        while(true){
            ...
            Log.i("MAKE_PING","Pecati go odgovorot od PING komanda vo Logcat");
            try{
    ...
    public void onDestroy() {
        ...
        Intent broadcastIntent = new Intent("com.example.msap_vtor_del");
